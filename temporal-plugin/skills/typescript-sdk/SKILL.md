...
### Reference Files
- **`references/determinism.md`** - V8 sandbox, bundling, safe operations, WHY determinism matters
- **`references/error-handling.md`** - ApplicationFailure, retry policies, idempotency keys
- **`references/testing.md`** - TestWorkflowEnvironment, time-skipping
- **`references/patterns.md`** - Signals, queries, cancellation scopes
- **`references/observability.md`** - Replay-aware logging, metrics, OpenTelemetry, debugging
- **`references/advanced-features.md`** - Interceptors, sinks, updates, schedules
